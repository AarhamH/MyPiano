...
using StudyHelper.Models.TokenAuth;
...
{
    public abstract class StudyHelperWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static StudyHelperWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(StudyHelperWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<StudyHelperDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<StudyHelperDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<StudyHelperDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<StudyHelperDbContext, Task<T>> func)
        {
            T result;
