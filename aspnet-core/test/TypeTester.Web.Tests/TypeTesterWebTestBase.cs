...
{
    public abstract class TypeTesterWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TypeTesterWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TypeTesterWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TypeTesterDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TypeTesterDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TypeTesterDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TypeTesterDbContext, Task<T>> func)
        {
            T result;
