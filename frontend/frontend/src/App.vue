    ...
    <section class="config-container">
      ...
      <div class="config-elem">
        <div class="config-elem-cell">
          ...
          <textarea
            :value="allKeys"
            @change="handleAllKeysChanges"
            rows="2"
            cols="60"
            style="margin-top: 1.5%"
            placeholder="add keys followed by semicolumns (e.g: a,s,d...)"
          >
          </textarea>
        </div>
      </div>
      ...
      <div class="config-elem">
        <div class="config-elem-cell">
          ...
          <input type="checkbox" v-model="showKeys" />
        </div>
        <div class="config-elem-cell">
        ...
        <div v-if="showNotes" class="config-elem-cell">
          <label> Indian Notes: </label>
          <input type="checkbox" v-model="indianNotes" />
        </div>
        <div class="config-elem-cell">
      ...
      <div v-if="indianNotes" class="config-elem">
        ...
        <div class="config-elem-cell">
          <label> Middle Octave </label>
          <input
            v-model="noteConfig.middleOctave"
            min="3"
            max="5"
            type="number"
          />
      ...
      <div class="config-elem">
        <div class="config-elem-cell">
          <label> White Note Color: </label>
          <input v-model="whiteNoteColor" type="color" />
        </div>
        <div class="config-elem-cell">
          <label> Black Note Color: </label>
          <input v-model="blackNoteColor" type="color" />
        </div>
      </div>
      ...
      <div class="config-elem">
        <div class="config-elem-cell">
          ...
          <input v-model="startOctave" min="1" max="8" type="number" />
        </div>
        <div class="config-elem-cell">
          <label> End Octave: </label>
          <input v-model="endOctave" min="1" max="8" type="number" />
        </div>
      </div>
      <!-- </div> -->
